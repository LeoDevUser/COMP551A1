...
for split in testsplits: #go through each split
    for i in range(10): #repeat ten time for each split to get error and average value
        #split the data
...
for i in range(len(testsplits)):
    ...
    test = MSE_ex3_train[i*10:(i+1)*10]
    train = MSE_ex3_test[i*10:(i+1)*10]
...
print(avg_MSE_ex3_train)
print(avg_MSE_ex3_test)
print(err_MSE_ex3_train)
print(err_MSE_ex3_test)
